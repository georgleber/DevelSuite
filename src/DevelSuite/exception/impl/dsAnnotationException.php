...
/**
 * Signals that an exception during parsing / instantiation
 * of an annotation has occured.
 *
 * @package DevelSuite\exception
 * @author  Georg Henkel <info@develman.de>
 * @version 1.0
 */
class dsAnnotationException extends dsErrorCodeException {
	const ID = "AnnotationException";

	const ANNOTATION_INVALID = 100;
