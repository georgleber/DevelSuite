...
class dsRequiredValidator extends dsAValidator {
    ...
    protected function init() {
        ...
        $errorMessage = "";
        if ($this->element instanceof dsSelect || $this->element instanceof dsRadioButtonGroup || $this->element instanceof dsRadioButton || $this->element instanceof dsCheckboxGroup || $this->element instanceof dsCheckbox) {
