...
<?php endif; ?>
<form class='dsform<?php if ($this->css != NULL) {
    echo " " . $this->css;
} ?>' id='<?php echo $this->id; ?>' action='<?php echo $this->action; ?>'
      method='<?php echo $this->method; ?>'<?php if ($this->enctype != NULL) {
